...
contract TestPurchase{
    ...
    Purchase purchases = Purchase(DeployedAddresses.Purchase());
    ...
    function testUserCanPurchase() public {
        uint returedId = purchases.purchase(expectedWallpaperId);
    ...
    function testGetPurchaserAddressByWallpaperId()public {
        address purchaser = purchases.purchasers(expectedWallpaperId);
